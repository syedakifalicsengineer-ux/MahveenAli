...
let score = 0;
const WIN_SCORE = 4; // Hearts needed to fill the meter
let player;
let hearts = [];
...
const loveSong = document.getElementById('love-song'); // 🎵 SONG ELEMENT
    ...
    if (gameState === 'PLAYING') {
        ...
        hearts.forEach((heart, index) => {
            ...
            if (
                ...
                if (score >= WIN_SCORE) {
                    triggerProposal(); // MUSIC WILL PLAY HERE
                }
...
function triggerProposal() {
    ...
    // 🎵 PLAY MUSIC AFTER HEARTS COLLECTED
    loveSong.currentTime = 0;
    loveSong.play().catch(()=>{});

    // 🔹 CHANGE BACKGROUND TO CRUSH IMAGE IMMEDIATELY
    document.body.style.background = "url('crush.jpg') center center / cover no-repeat";
